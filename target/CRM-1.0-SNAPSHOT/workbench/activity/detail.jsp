            ...
            $.ajax({
                ...
                success:function (data) {
                    if (data.success){
                        ...
                        html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;id="x'+n.id+'">'+data.ar.createTime+' 由'+data.ar.createBy+'</small>';
            ...
            $.ajax({
                ...
                success:function (data) {
                    if (data.success){
                         ...
                         */
                        //修改备注成功，需要更新notecontent，修改人，修改时间

                        $("#e"+id).html(data.ar.noteContent);

                        var divs = $("#s"+id).children("small");
                        divs.html(data.ar.editTime+' 由'+data.ar.editBy);
			...
			$.ajax({
				...
				success:function (data) {
					...
					$.each(data,function (i,n) {
					    //alert('<small style="color: gray; id="'+n.id+'w">');
					html+='<div id="'+n.id+'" class="remarkDiv" style="height: 60px;">';
					html+='<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
					html+='<div style="position: relative; top: -40px; left: 40px;"  id="s'+n.id+'">';
					html+='<h5 id="e'+n.id+'">'+n.noteContent+'</h5>';
					html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray"; id="'+n.id+'w">'+(n.editFlag==0?n.createTime:n.editTime)+' 由'+(n.editFlag==0?n.createBy:n.editBy)+'</small>';
					html+='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
					html+='<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" onclick="editRemark(\''+n.id+'\')" style="font-size: 20px; color: #FF0000;"></span></a>';
					html+='&nbsp;&nbsp;&nbsp;&nbsp;';
